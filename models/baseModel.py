    ...
    def resume_training(self, resume_state):
        ...
        for i, o in enumerate(resume_optimizers):
            ...
            # for g in self.optimizers[i].param_groups:
                ...
                #     g['lr_lambda'] = 1.0
                # else:
                #     g['lr_lambda'] = self.config.distill_lambda
                # #
                # g['lr'] = self.config.lr_init * g['lr_lambda']
                # g['initial_lr'] = self.config.lr_init * g['lr_lambda']
