...
def set_eval_path(config, data):
    if data == 'DVD':
        ...
        #config.EVAL.input_path = 'reds_test'
        #config.EVAL.gt_path = 'reds_test_gt'
        ...
        config.EVAL.data_path = os.path.join(config.data_offset+'_fusion_transformer', 'MPRNet', 'test_nah')
        config.EVAL.input_path = 'blur'
        config.EVAL.gt_path = 'sharp'
